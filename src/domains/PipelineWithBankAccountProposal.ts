...
export class PipelineWithBankAccountProposal {
  private id: string;
  ...
  public getProposals(): BankAccount[] {
    return this.proposals;
  }

  public setProposals(proposals: BankAccount[]): void {
