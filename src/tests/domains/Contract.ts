...
contract.setAcceptedCheckSum(['ok', 'ok2']);
...
const json = `{"acceptedCheckSum":["ok","ok2"],"logData":{"ip":"192.158.1.38","latitude":38.895,"longitude":-77.0364,"mac":"00:00:5e:00:53:af","occurrenceDate":"2022-10-22 14:10:20","userAgent":"Test Agent"}}`;
